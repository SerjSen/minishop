...
class Product
{
    ...
    public static function getLatestProducts($count = self::SHOW_BY_DEFAULT)
    {
        ...
        $result = $db->query('SELECT id, name, price, image, is_new FROM product WHERE status = "1" ORDER BY id ASC LIMIT ' . $count);
    ...
    public static function getRecomended()
    {
        ...
        $result = $db->query('SELECT id, name, price, image, is_new FROM product WHERE status = 1 AND
                                is_recommended = "1"
                                ORDER BY id DESC ');
        $i = 0;
        $products = array();
